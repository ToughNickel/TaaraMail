...
def send_my_message(access_token, payload):
    send_message_url = graph_endpoint.format('/me/sendMail')
    ...
    r = make_api_call('POST', send_message_url, access_token, payload=payload)
